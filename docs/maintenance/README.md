# Manutencao do Projeto Freguesia

Este diretorio concentra a documentacao operacional das telas do projeto e os guias de manutencao do ambiente.

## Estrutura

- `deploy-vps.md`: fluxo operacional para publicar alteracoes na VPS em `/root/Freguesia`.
...
- `screens/attendance.md`: tela de atendimento.
