export const NAVIGATION_PERMISSION_OPTIONS = [
  ...
  ['kanban', 'Visão Kanban', 'Acessa o quadro Kanban e o funil operacional.'],
...
export const getFirstAllowedNavigationPath = (user) => {
  const orderedRoutes = ['/', '/dashboard', '/kanban', '/quick-replies', '/customers', '/labels', '/chatbot', '/rotinas', '/hsms', '/settings'];
