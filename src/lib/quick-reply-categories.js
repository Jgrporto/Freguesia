...
export const DEFAULT_QUICK_REPLY_CATEGORIES = [
  { id: 'cat-apps', name: 'Aplicativos', color: '#38bdf8', icon: 'app', sortOrder: 10 },
  { id: 'cat-tests', name: 'Testes', color: '#a78bfa', icon: 'test', sortOrder: 20 },
  { id: 'cat-payment', name: 'Pagamento', color: '#22c55e', icon: 'payment', sortOrder: 30 },
  { id: 'cat-none', name: 'Sem Categoria', color: '#94a3b8', icon: 'folder', sortOrder: 999 },
];
